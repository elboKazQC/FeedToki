...
export const FOOD_DB: FoodItem[] = [
  ...
  { id: 'boeuf_maigre', name: 'Boeuf maigre', tags: ['proteine_maigre'], baseScore: 85, protein_g: 26, carbs_g: 0, fat_g: 7, calories_kcal: 165, points: 0 },
  { id: 'viande_fondue', name: 'Viande à fondue', tags: ['proteine_maigre'], baseScore: 85, protein_g: 26, carbs_g: 0, fat_g: 7, calories_kcal: 165, points: 0 },
  { id: 'viande_fondu', name: 'Viande fondu', tags: ['proteine_maigre'], baseScore: 85, protein_g: 26, carbs_g: 0, fat_g: 7, calories_kcal: 165, points: 0 },
  { id: 'boeuf_laniere', name: 'Boeuf en lanières', tags: ['proteine_maigre'], baseScore: 85, protein_g: 26, carbs_g: 0, fat_g: 7, calories_kcal: 165, points: 0 },
  { id: 'steak_hache_maigre', name: 'Steak haché maigre', tags: ['proteine_maigre'], baseScore: 85, protein_g: 26, carbs_g: 0, fat_g: 9, calories_kcal: 180, points: 0 },
  { id: 'viande_hachee_maigre', name: 'Viande hachée maigre', tags: ['proteine_maigre'], baseScore: 85, protein_g: 26, carbs_g: 0, fat_g: 9, calories_kcal: 180, points: 0 },
  ...
  { id: 'shake_chocolate', name: 'Shake protéine Chocolat', tags: ['proteine_maigre', 'sucre'], baseScore: 70, protein_g: 25, carbs_g: 8, fat_g: 2, calories_kcal: 170, points: 0 },
  { id: 'shake_vanille', name: 'Shake protéine Vanille', tags: ['proteine_maigre', 'sucre'], baseScore: 70, protein_g: 25, carbs_g: 8, fat_g: 2, calories_kcal: 170, points: 0 },
  { id: 'shake_fruits', name: 'Shake protéine Fruits rouges', tags: ['proteine_maigre', 'sucre'], baseScore: 70, protein_g: 24, carbs_g: 10, fat_g: 2.5, calories_kcal: 180, points: 0 },
