@echo off
REM Script pour configurer le webhook secret Stripe dans Firebase Functions (Windows)
REM Usage: setup-webhook-secret.bat

echo ⚠️  Configuration du webhook secret Stripe PRODUCTION
echo.

REM Webhook secret Stripe (PRODUCTION)
set STRIPE_WEBHOOK_SECRET=whsec_qf4mVsFuJD9p07K8t6eYw1nayAbMuOej
