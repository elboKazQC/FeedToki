@echo off
REM Script pour configurer le webhook secret Stripe TEST dans Firebase Functions (Windows)
REM Usage: setup-webhook-secret-test.bat
REM
REM Webhook secret TEST fourni: whsec_oufgvtk4nrHCgSFwtBW945gsjT0qBjEy

echo ⚠️  Configuration du webhook secret Stripe TEST
echo.

REM Webhook secret Stripe (TEST)
set STRIPE_WEBHOOK_SECRET=whsec_oufgvtk4nrHCgSFwtBW945gsjT0qBjEy
